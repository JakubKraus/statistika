...
# 1) stáhnete si nejnovìjší balíèek prob_1.0-0.tar.gz z https://cran.r-project.org/src/contrib/Archive/prob/prob_1.0-0.tar.gz
# 2) nastavte Working Directory do místa stažení balíèku
# 3) nainstalujte:
